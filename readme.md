...
based on nette/mail:2:3.5
added support for TLS 1.2 in SmtpMailer::connect

this repo can be deleted after update to nette/mail:2:4
...
[![Build Status](https://travis-ci.org/nette/mail.svg?branch=v2.3)](https://travis-ci.org/nette/mail)
